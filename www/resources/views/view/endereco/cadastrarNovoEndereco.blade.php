    ...
    <body>
    <form action="{{route('endereco_create')}}" id="form_endereco"method="POST">
        @csrf
        <div class="row mb-3">
        ...
        <label class="form-check-label" >Principal</label>
                ...
                <div>
                    ...
                    <a class="btn btn-primary" href="{{route('endereco_index',$id)}}">Voltar</a>
        </div>
    @if (\Session::has('registrado'))
        <div class="alert alert-success">
            <ul>
                <li>{!! \Session::get('registrado') !!}</li>
            </ul>
        </div>
    @endif
    </div>
